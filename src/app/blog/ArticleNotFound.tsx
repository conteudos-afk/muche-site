  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative z-10">
      <div className="text-center">
        ...
        <motion.a href="/blog" onClick={linkHandler("/blog", onNavigate)} whileHover={{ x: -3 }} style={{ color: GOLD, fontFamily: SANS, fontWeight: 300, fontSize: "13px", letterSpacing: "3px", textTransform: "uppercase", opacity: 0.6, background: "none", border: "none", cursor: "pointer", display: "flex", alignItems: "center", gap: "8px", margin: "0 auto", textDecoration: "none", width: "fit-content" }}>
